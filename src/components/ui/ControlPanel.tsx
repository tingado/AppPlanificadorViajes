        ...
        {destinations.map((dest) => {
          ...
          return (
            <button
              ...
              className="relative overflow-hidden rounded-xl border-2 border-transparent hover:border-brand-400 transition-all text-center h-36 group"
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center gap-1 h-full px-2">
